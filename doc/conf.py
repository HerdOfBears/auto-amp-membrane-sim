...
# -*- coding: utf-8 -*-
#
# autoams documentation build configuration file, created by
...
latex_documents = [
  ('index', 'autoams.tex', 'autoams Documentation',
   'First Last', 'manual'),
]
...
man_pages = [
    ('index', 'autoams', 'autoams Documentation',
     ['First Last'], 1)
]
...
texinfo_documents = [
  ('index', 'autoams', 'autoams Documentation',
   'First Last', 'autoams', 'One line description of project.',
   'Miscellaneous'),
]
